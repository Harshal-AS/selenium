...
//		//String name="Mumbai"; 
//// object creation scanner class
//		Scanner scaref=new  Scanner(System.in);
//		int age;
//		double salary;
//		String name;
//		boolean valid;
//		// initilized the variables using scanner
//		// variable =ref.nextInt();
//		System.out.println("Enter the age from the consol");
//		age = scaref.nextInt();
//		System.out.println("Enter the salary from the consol");
//		salary=scaref.nextDouble();
//		System.out.println("Enter the name from the consol");
//		name=scaref.next();
//		System.out.println("Enter the boolean  true/ false the consol");
//		valid =scaref.nextBoolean();
