...
class JD {
	...
	void disp() {
		System.out.println("JournalDev disp method");//METHOD OVERRIDING
	}
}
//Inherited class
class Java extends JD {
	...
	void disp() {
		System.out.println("Java disp method");//METHOD OVERRIDING
	}
}
//Inherited class
class Android extends Java {
	...
	void disp() {
		System.out.println("Android disp method");// METHOD OVERRIDING
	}
}
